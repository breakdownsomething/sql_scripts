...
/*
 ...
 Name:                pProCorrectionReference
                      (old name "sp_ProCorrectionReference")
 ...
 Note:                Версия 1.1 (4.06.2004) Доработана с учетом появления
                      нового поля contract_id в таблице ProEditRecords

                      Версия 1.2 (16.08.2004) Изменено имя процедуры
                      (префикс "sp_" заменен на "p"), а также закоментировано
                      создание первичного ключа на временной таблице
                      #TmpProEditRecords, вызывавшее ошибку призапуске
                      процедуры несколькими пользователями одновременно.
*/
----------------------------------------------------------------------------------/
CREATE  PROCEDURE dbo.pProCorrectionReference
	@contract_id  int,
  @begin_date   datetime,
  @end_date     datetime
AS
