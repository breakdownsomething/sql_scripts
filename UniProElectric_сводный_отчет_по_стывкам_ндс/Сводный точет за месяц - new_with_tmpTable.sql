...
select
 ...
 ,@dtNextEnd =  dateadd(dd,-1,dateadd(mm,+1,Dateadd(dd,+1,'2004-02-29')))
...
-- работают гораздо медленее. (а update-ов здес хватает ;) )                    |
--------------------------------------------------------------------------------
...
--<4>---------------------------------------------------------------------------------------------
--    Расчет и заполнение платежей как                                                            |
--      платежи = сальдо на начало - сальдо на конец + начисления                                 |
--------------------------------------------------------------------------------------------------
update #TmpProDivSal
set
...
--select count(distinct contract_id) from #TmpProDivSal
