----------------------------------------------------------------
-- Скрипт удаляет все электрические услуги на выбранном
-- лицевом счете
---------------------------------------------------------------
declare
  @mask_ss_delete         int,
...
--2) Идем курсором по корректировкм и дублируем их в aspElectric..EditRecords
