...
Цель модификации:	Учет расчета потерь в трансформаторах из таблицы ProTrancPowerLoss
...
Модифицировал:		Матесов Д.
-------------------------------------------------------------------------------------------
Дата модификации:	20.12.2004 
Цель модификации:	Добавление данных по местному бюджету в поле 
                  CONSUMER_BUDGET_ID в таблице ProCalcs.
Модифицировал:		Матесов Д.
****************************************************************************/
...
UPDATE
 ...
 SET
  ...
  CONSUMER_BUDGET_ID = (select CONSUMER_BUDGET_ID 
